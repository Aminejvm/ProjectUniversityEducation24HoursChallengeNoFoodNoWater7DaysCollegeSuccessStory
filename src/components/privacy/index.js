...
const Privacy = ()=>{
    return (<Layout style={{backgroundColor:'white'}}><Content style={{backgroundColor:'white'}}>
        
        <h1>Politique de Confidentialité</h1>


        <p>Date de prise d'effet: September 12, 2019</p>
        
        
        <p>Uni Search ("nous", "notre", "nos") exploite le site web unisearch.com (ci-après désigné par le terme "Service").</p>
        
        
        <p>Nous utilisons vos données pour fournir et améliorer le Service. En utilisant le Service, vous consentez à la collecte et à l'utilisation d'informations conformément à la présente politique. Sauf définition contraire dans la présente Politique de Confidentialité, les termes utilisés dans la présente Politique de Confidentialité ont la même signification que dans nos Conditions Générales qui sont disponibles sur unisearch.com</p>
        
        <h2>Définitions</h2>
        <ul>
            <li>
                <p><strong>Service</strong></p>
                        <p>Par Service on entend le site web unisearch.com exploité par Uni Search</p>
                    </li>
            <li>
        ...
        <p>Uni Search utilise les données recueillies à des fins diverses:</p>    
        <ul>
        ...
        <ul>
                ...
                <p>Statcounter est un outil d'analyse de trafic web. Vous pouvez lire la politique de confidentialité de Statcounter ici: <a href="https://statcounter.com/about/legal/">https://statcounter.com/about/legal/</a></p>
            </li>
                        </ul>
        ...
        <ul>
                <li>Par courrier électronique: admin@unisearch.com</li>
